package com.dogametal.resources;
...
import com.dogametal.resources.util.URL;
import com.dogametal.services.PostService;
...
public class PostResource {
	...
	@RequestMapping(value ="/person", method = RequestMethod.GET) // Another way to use this request @GetMapping
	public ResponseEntity <List<Post>> findbyPerson(@RequestParam(value="text", defaultValue = "") String text ){		
		text = URL.decodeParam(text);
		List<Post> list = service.findPerson(text);
		return ResponseEntity.ok().body(list);  
	}
